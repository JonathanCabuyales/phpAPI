...
$mod = new Modulo();
$codigo = $fechaactual.$tipocomprobante.$tipoambiente.$serie.$secuencial.$codigonumerico.$tipoemision;
...
$xmlfactura->startElement("factura");
    ...
    $xmlfactura->startElement("infoFactura");
        ...
        // inicio de la seccion totoal con impuestos
    ...
    for ($i = 0; $i < count($servicios_fac); $i++){
