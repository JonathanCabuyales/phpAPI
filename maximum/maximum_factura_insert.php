...
$id_asiento = $jsonAsientoFormulario->id_asiento;
$num_factura = $jsonAsientoFormulario->num_factura;
$tipo_comprobante = $jsonAsientoFormulario->tipo_comprobante;
$detalle = $jsonAsientoFormulario->detalle;
...
try {
    ...
    $query = "INSERT INTO movimiento (
        ...
        tipo_comprobante, 
        detalle ) 
    VALUES ('$id_asiento', '$num_factura', '$tipo_comprobante', '$detalle')";
