...
$id_asiento = $jsonCliente->id_cli;
$num_factura = $jsonCliente->id_cli;
$tipo_comprobante = $jsonCliente->id_cli;
$detalle = $jsonCliente->id_cli;
...
try {
    ...
    $query = "UPDATE movimiento SET id_asiento='$id_asiento', num_factura='$num_factura', tipo_comprobante='$tipo_comprobante', detalle='$detalle'
