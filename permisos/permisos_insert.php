...
$fecha_per = $jsonPermiso->fecha_per;
$motivo_per  = $jsonPermiso->motivo_per;
$aprobado_per = $jsonPermiso->aprobado_per;
$fechaapro_per = $jsonPermiso->fechaapro_per;
...
try {
    ...
    aprobado_per,
    fechaapro_per) 
    VALUES ('$id_usuario', '$fecha_per', '$motivo_per', '$aprobado_per',
    '$fechaapro_per')";
