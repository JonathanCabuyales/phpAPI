...
$descripcion_esusu = $jsonEmpleado->descripcion_esusu;
$fecha_baja_esusu = $jsonEmpleado->fecha_baja_esusu;
...
try {
    ...
    $query = "UPDATE estado_usuario set 
    descripcion_esusu = '$descripcion_esusu',
    fecha_baja_esusu = '$fecha_baja_esusu'
