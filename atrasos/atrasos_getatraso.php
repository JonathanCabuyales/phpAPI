...
$fecha = $jsonAtraso->fecha_atr;
$descripcion = $jsonAtraso->descripcion_atr;
...
try {
    ...
    WHERE atr.fecha_atr = '$fecha'
    AND atr.descripcion_atr = '$descripcion'
    AND atr.id_usuario = '$id_usuario'";
