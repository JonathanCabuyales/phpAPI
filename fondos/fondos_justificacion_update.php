...
$id_fonjus = $jsonFondoJusti->id_fonjus;
...
try {
    ...
    $query = "UPDATE fondos_justificados SET
    detalles_fonjus = '$detalles_fonjus', 
    justificado_fonjus = '$justificado_fonjus', 
    nojustificado_fonjus= '$nojustificado_fonjus'
    WHERE id_fonjus = '$id_fonjus'";
