...
try {
    ...
    $query = "SELECT * FROM usuarios usu, fondos fon, fondos_justificados fonjus
    WHERE usu.id_usuario = fon.id_usuario
    AND fonjus.id_usuario = fon.id_usuario
    AND fonjus.id_fon = fon.id_fon
    ORDER BY usu.apellidos";
